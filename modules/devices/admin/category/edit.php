 ...
 * @Controller Category Edit - Optimized with Template
 */
...
// ===== XỬ LÝ TEMPLATE =====
$xtpl = new XTemplate('category_edit.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $module_file);

// Gán dữ liệu cơ bản
$xtpl->assign('FORM_ACTION', NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&' . NV_NAME_VARIABLE . '=' . $module_name . '&' . NV_OP_VARIABLE . '=category/edit&id=' . $id);
