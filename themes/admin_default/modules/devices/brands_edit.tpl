            ...
            <div class="card-custom">
                ...
                <div class="card-body-custom">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control form-control-custom" value="{DATA.title}" required>
                    </div>

                    <div class="form-group">
                        <label style="font-weight:600;">Website hỗ trợ</label>
                        <input type="url" name="support" class="form-control form-control-custom" value="{DATA.support}">
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" name="submit" class="btn btn-custom-edit shadow-sm">
