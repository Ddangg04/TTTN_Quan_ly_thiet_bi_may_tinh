...
<style>
    ...
    .btn-custom-save { border-radius: 6px; padding: 10px 35px; font-weight: bold; background-color: #337ab7; border-color: #2e6da4; color: #fff; transition: 0.3s; }
    .btn-custom-save:hover { background-color: #286090; transform: translateY(-1px); box-shadow: 0 4px 8px rgba(0,0,0,0.1); }
            ...
            <div class="card-custom">
                <div class="card-header-custom">
                    <h3 class="panel-title" style="font-size: 18px; color: #2c3e50;">
                        ...
                        <strong>Thêm danh mục thiết bị mới</strong>
                    </h3>
                </div>
                <div class="card-body-custom">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <textarea name="description" class="form-control form-control-custom" rows="4" placeholder="Nhập một vài mô tả ngắn về danh mục này...">{DATA.description}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group" style="margin-left:0; margin-right:0;">
                                ...
                                <div class="help-block-custom"><i class="fa fa-info-circle"></i> Nhập 0 để hệ thống tự động sắp xếp xuống cuối</div>
                            </div>
                        </div>
                    </div>
